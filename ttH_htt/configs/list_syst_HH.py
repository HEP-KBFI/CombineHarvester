...
theory_ln_Syst = {
    ...
    "CMS_bbwwsl_tt": {"value": 1.30,        "proc" : ["TT", "ST"]},
    "CMS_bbwwsl_wjets": {"value": 1.30,     "proc" : ["WJets"]},
#https://arxiv.org/pdf/1610.07922.pdf
    "QCDscale_ttZ" : {"value": (0.898 , 1.096),   "proc" : ["TTZ", "ttZ"]}, # old (0.887 , 1.096)
    "QCDscale_ttW" : {"value": (0.897 , 1.129),   "proc" : ["TTW", "ttW"]}, # old (0.885 , 1.129) 
    "pdf_ttZ"      : {"value": 1.028,             "proc" : ["TTZ", "ttZ"]},  # includes alpha s 
    "pdf_ttW"      : {"value": 1.02,              "proc" : ["TTW", "ttW"]},
    "alpha_s_ttZ"  : {"value": 1.028,             "proc" : ["TTZ", "ttZ"]},
    "alpha_s_ttW"  : {"value": 1.027,             "proc" : ["TTW", "ttW"]},

    "EW_ttZ"       : {"value": (0.998,1.0),       "proc" : ["TTZ", "ttZ"]},  
    "EW_ttW"       : {"value": (0.969,1.0),       "proc" : ["TTW", "ttW"]},   # old (0.968,1.0)
...
# other WZ/ZZ
    ...
    "pdf_VV"       : {"value" : 1.003,            "proc" : ["VV"]},
    "QCDscale_VV"  : {"value" : (0.995,1.006),    "proc" : ["VV"]},
    "pdf_ST"       : {"value" : 1.049,            "proc" : ["ST"]},
    "QCDscale_ST"  : {"value" : (0.965,1.052),    "proc" : ["ST"]},
    "DY_xs"        : {"value" : 1.02,             "proc" : ["DY"]},
    }
...
def specific_syst(analysis, list_channel_opt, channel="multilepton") :
    ...
    if analysis == "HH" :
        ...
        if 'bbww' in channel:
            #specific_ln_systs["CMS_tt"] = {"value": 1.30,   "correlated": True, "renameTo": "CMS_%s_tt_in_EVTCAT_ERA"%channel, "proc" : ["TT", "ST"], "channels": ["1l_0tau", "2l_0tau"]}
            #specific_ln_systs["CMS_wjets"] = {"value": 1.30, "correlated": True, "renameTo": "CMS_%s_wjets_in_EVTCAT_ERA"%channel, "proc" : ["WJets"], "channels" : ["1l_0tau", "2l_0tau"]}
            #specific_ln_systs["CMS_Other_EVTCAT"] = {"value": 1.30, "correlated": True, "renameTo": "CMS_%s_Other_in_EVTCAT"%channel, "proc" : ["Other_bbWW"], "channels" : ["1l_0tau", "2l_0tau"]}
            #specific_ln_systs["CMS_SingleHiggs"] = {"value": 1.30, "correlated": True, "renameTo": "CMS_%s_SingleHiggs"%channel, "proc" : ["SingleHiggs"], "channels" : ["1l_0tau", "2l_0tau"]}
            #specific_ln_systs["CMS_SH"] = {"value": 1.30, "correlated": True, "renameTo": "CMS_%s_SingleHiggs_in_EVTCAT"%channel, "proc" : ["SingleHiggs"], "channels" : ["1l_0tau", "2l_0tau"]}
            #specific_ln_systs["CMS_Fakes_decorelate"] = {"value": 1.2,  "correlated": False,  "renameTo": "CMS_%s_fakes_EVTCAT_Era"%channel, "proc": ["Fakes"],     "channels": [k for k,v in list_channel_opt.items() if "Fakes"  in v["bkg_proc_from_data"]]}  # for channels with "fakes_data"
            specific_ln_systs["CMS_Fakes"] = {"value": 1.3,  "correlated": True,  "renameTo": "CMS_%s_fakes"%channel, "proc": ["Fakes"],     "channels": [k for k,v in list_channel_opt.items() if "Fakes"  in v["bkg_proc_from_data"]]}
        ...
        specific_shape = {
            ...
            "CMS_ttHl_lepEff_muloose"       : {"correlated" : False,  "renameTo" : "CMS_%s_eff_mloose_Era" %channel,  "proc" : "MCproc", "channels" : list(set(list(list_channel_opt.keys())) - set(["0l_4tau"]))},
            # ############################## Tau related:
           ...
           # "CMS_ttHl_EWK_jet"      : {"correlated" : True, "renameTo" : "CMS_multilepton_EWK_jet"   , "proc" : ["WZ"], "channels" : [k for k,v in list_channel_opt.items() if "WZ" in v["bkg_procs_from_MC"] or "ZZ" in v["bkg_procs_from_MC"]]}, ## added only on SRs atm
            ...
            # ##################################### MC closure
            "CMS_ttHl_Clos_e_shape"  : {"correlated" : False, "renameTo": "CMS_%s_Clos_e_shape_Era" %channel,  "proc" : ["Fakes"], "channels" : ["3l","2lss", "WZCR", "ZZCR", "1l_0tau"]}, # should be only 2018, that is done on the main code            
            "CMS_ttHl_Clos_m_shape"  : {"correlated" : False, "renameTo" : "CMS_%s_Clos_m_shape_Era"%channel,  "proc" : ["Fakes"], "channels" : ["3l","2lss", "WZCR", "ZZCR", "1l_0tau"]}, # there is no shape tend in
            ...
            "CMS_ttHl_Clos_e_norm"   : {"correlated" : False, "renameTo" : "CMS_%s_Clos_e_norm_Era"%channel,   "proc" : ["Fakes"], "channels" : ["3l","2lss", "WZCR", "WZCR", "ZZCR", "1l_0tau"]},
            "CMS_ttHl_Clos_m_norm"              : {"correlated" : False, "renameTo" : "CMS_%s_Clos_m_norm_Era"%channel,    "proc" : ["Fakes"], "channels" : ["3l","2lss", "WZCR", "ZZCR", "1l_0tau"]},
            ...
            "CMS_hbbhwwdl_DY_Clos_norm"           : {"correlated" : False, "renameTo" : "CMS_bbwwdl_DY_Clos_norm_Era",         "proc" : ["data_DY"], "channels" : ["1l_0tau", "2l_0tau"]}, 
            "CMS_hbbhwwdl_DY_Clos_shape"          : {"correlated" : False, "renameTo" : "CMS_bbwwdl_DY_Clos_shape_Era",         "proc" : ["data_DY"], "channels" : ["2l_0tau"]},
