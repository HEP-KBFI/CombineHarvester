...
def specific_syst(analysis, list_channel_opt) :
    ...
    if analysis == "ttH" :
        ...
        specific_shape = {
            ...
            ######## theory
            "CMS_ttHl_thu_shape_ttH"     : {"correlated" : True, "renameTo" : None, "proc" : "ttHproc", "channels" : [k for k in list_channel_opt]},
            "CMS_ttHl_thu_shape_tHq"     : {"correlated" : True, "renameTo" : None, "proc" : "tHqproc", "channels" : [k for k in list_channel_opt]},
            "CMS_ttHl_thu_shape_tHW"     : {"correlated" : True, "renameTo" : None, "proc" : "tHWproc", "channels" : [k for k in list_channel_opt]},
            "CMS_ttHl_thu_shape_ttW"     : {"correlated" : True, "renameTo" : None, "proc" : "TTWproc", "channels" : [k for k,v in list_channel_opt.items() if "TTW" in v["bkg_procs_from_MC"]]},
            ...
            "CMS_ttHl_thu_shape_HH"      : {"correlated" : True, "renameTo" : None, "proc" : "HHproc", "channels" : [k for k in list_channel_opt]},
            "CMS_ttHl_thu_shape_ggH"     : {"correlated" : True, "renameTo" : None, "proc" : "ggHproc", "channels" : [k for k in list_channel_opt]},
            "CMS_ttHl_thu_shape_qqH"     : {"correlated" : True, "renameTo" : None, "proc" : "qqHproc", "channels" : [k for k in list_channel_opt]},
            "CMS_ttHl_thu_shape_VH"      : {"correlated" : True, "renameTo" : None, "proc" : "VHproc", "channels" : [k for k in list_channel_opt]},
