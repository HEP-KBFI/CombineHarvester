def list_channels( fake_mc, signal_type="none", mass="none", HHtype="none", renamedHHInput=False ) :
    ...
    info_channel = {
        "2l_0tau" : {
            ...
            "bkg_procs_from_MC"  : ["TT", "ST", "Other_bbWW", "WJets", "VV", "VVV", "TTWW", "ttZ", "ttW"] + higgs_procs_w_BR,
            "isSMCSplit" : False,
            "proc_to_remove" : {}
        },
        "1l_0tau" : {
            "bkg_proc_from_data" : [ fakes    ],
            "bkg_procs_from_MC"  : ["TT", "ST", "Other_bbWW", "DY", "WJets", "VV", "VVV", "TTWW", "ttZ", "ttW"] + higgs_procs_w_BR + thprocs_bbww,
            "isSMCSplit" : False,
            "proc_to_remove" : {}
        },
        "0l_4tau" : {
