...
firstpart ='/home/snandan/hh_Analysis/CombineHarvestr/CMSSW_8_1_0/src/CombineHarvester/ttH_htt/dumb_bb2l_SM/datacards_rebined/datacard_hh_bb2l_LBN'
lastpart_DY_resolved = '30bins_quantiles.txt'
lastpart_DY_boosted = '20bins_quantiles.txt'
lastpart_TT_resolved = '20bins_quantiles.txt'
lastpart_TT_boosted = '20bins_quantiles.txt'
if signal_type == 'nonresNLO':
    lastpart_HH_resolved_2b_nonvbf = '4bins_quantiles.txt' #'10bins_quantiles.txt'
    lastpart_HH_resolved_2b_vbf = '3bins_quantiles.txt' #'4bins_quantiles.txt'
    lastpart_HH_resolved_1b_vbf = '4bins_quantiles.txt' #'5bins_quantiles.txt'
    lastpart_HH_resolved_1b_nonvbf = '20bins_quantiles.txt'#'15bins_quantiles.txt'
    lastpart_HH_boosted = '2bins_quantiles.txt'#'5bins_quantiles.txt'
else:
    lastpart_HH_resolved_2b_nonvbf = '5bins_quantiles.txt'
    lastpart_HH_resolved_2b_vbf = '5bins_quantiles.txt'
    lastpart_HH_resolved_1b = '5bins_quantiles.txt'
    lastpart_HH_boosted = '4bins_quantiles.txt'
...
for mode in modes:
    if method == 'bdt':
        cmd = 'combineCards.py resolved_2b_vbf=%s_resolved_2b_vbf_OS_MVAOutput_%s_%s resolved_2b_nonvbf=%s_resolved_2b_nonvbf_OS_MVAOutput_%s_%s resolved_1b=%s_resolved_1b_OS_MVAOutput_%s_%s boosted=%s_boosted_OS_MVAOutput_%s_%s' %(firstpart, mode, lastpart, firstpart, mode, lastpart, firstpart, mode, lastpart_1b, firstpart, mode, lastpart)
    else:
        cmd = 'combineCards.py HH_resolved_2b_vbf=%s_HH_resolved_2b_vbf_OS_MVAOutput_%s_%s HH_resolved_2b_nonvbf=%s_HH_resolved_2b_nonvbf_OS_MVAOutput_%s_%s HH_resolved_1b_vbf=%s_HH_resolved_1b_vbf_OS_MVAOutput_%s_%s HH_resolved_1b_nonvbf=%s_HH_resolved_1b_nonvbf_OS_MVAOutput_%s_%s HH_boosted=%s_HH_boosted_OS_MVAOutput_%s_%s TT_resolved=%s_TT_resolved_OS_MVAOutput_%s_%s TT_boosted=%s_TT_boosted_OS_MVAOutput_%s_%s DY_resolved=%s_DY_resolved_OS_MVAOutput_%s_%s DY_boosted=%s_DY_boosted_OS_MVAOutput_%s_%s SingleTop_resolved=%s_SingleTop_resolved_OS_MVAOutput_%s_%s SingleTop_boosted=%s_SingleTop_boosted_OS_MVAOutput_%s_%s Other=%s_Other_OS_MVAOutput_%s_%s' %(firstpart, mode, lastpart_HH_resolved_2b_vbf, firstpart, mode, lastpart_HH_resolved_2b_nonvbf, firstpart, mode, lastpart_HH_resolved_1b_vbf, firstpart, mode, lastpart_HH_resolved_1b_nonvbf, firstpart, mode, lastpart_HH_boosted, firstpart, mode, lastpart_TT_resolved, firstpart, mode, lastpart_TT_boosted,  firstpart, mode, lastpart_DY_resolved, firstpart, mode, lastpart_DY_boosted, firstpart, mode, lastpart_ST_resolved, firstpart, mode, lastpart_ST_boosted, firstpart, mode, lastpart_Other)
